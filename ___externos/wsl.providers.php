...
$WORDPRESS_SOCIAL_LOGIN_PROVIDERS_CONFIG = ARRAY(
	ARRAY( 
		...
		"provider_name"     => "Regístrate con Facebook", 
	...
	ARRAY(
		"provider_id"       => "Google",
		"provider_name"     => "Regístrate con Google",
		"callback"          => true,
		"require_client_id" => true,
	...
	ARRAY( 
		"provider_id"       => "Twitter",
		"provider_name"     => "Regístrate con Twitter", 
		"callback"          => true,
	...
	ARRAY( 
		...
		"provider_name"     => "Regístrate con LinkedIn", 
	...
	ARRAY( 
		...
		"provider_name"     => "Regístrate con Instagram", 
		"callback"          => true,
		"require_client_id" => true,
