			...
			<div id="login-panel">
				...
				<section id="mapping-options">
					<!-- <tr> -->
						...
						<div class="bloque1_registro"> <!-- <td valign="top"  width="50%" style="text-align:center;"> -->
							<h4 class="titulo_bienvenida"><?php _wsl_e( "New to our website", 'wordpress-social-login' ); ?></h4>
					...
					<tr>
						...
						<div class="bloque2_registro"> <!-- <td valign="top"  width="50%" style="text-align:center;"> -->
							<?php if( $require_email != 1 && $change_username != 1 && $extra_fields != 1 ): ?>
                                <input type="button" value="<?php _wsl_e( "Create a new account", 'wordpress-social-login' ); ?>" class="button-primary btn_carnet" onclick="document.getElementById('info-form').submit();" >
							<?php else : ?>
                                <input type="button" value="<?php _wsl_e( "Create a new account", 'wordpress-social-login' ); ?>" class="button-primary btn_carnet" onclick="display_mapping_complete_info();" >
                            <?php endif; ?>
						</td>
					</tr>
				</section>
					...
					<table id="mapping-authenticate" border="0">
						...
						<tr>
							<td valign="bottom"  width="50%" style="text-align:left;">
								...
								<input type="submit" value="<?php _wsl_e( "Continue", 'wordpress-social-login' ); ?>" class="button-primary btn_carnet" >
